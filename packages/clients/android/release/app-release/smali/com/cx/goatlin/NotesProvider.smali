.class public final Lcom/cx/goatlin/NotesProvider;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/cx/goatlin/NotesProvider$a;
    }
.end annotation


# static fields
.field public static final e:Lcom/cx/goatlin/NotesProvider$a;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/cx/goatlin/NotesProvider$a;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/cx/goatlin/NotesProvider$a;-><init>(Lg1/b;)V

    sput-object v0, Lcom/cx/goatlin/NotesProvider;->e:Lcom/cx/goatlin/NotesProvider$a;

    const-string v0, "com.cx.goatlin.notes"

    sput-object v0, Lcom/cx/goatlin/NotesProvider;->f:Ljava/lang/String;

    const-string v1, "Notes"

    sput-object v1, Lcom/cx/goatlin/NotesProvider;->g:Ljava/lang/String;
    ...
    const-string v1, "parse(\"content://\" + AUT\u2026             NOTES_TABLE)"

    invoke-static {v0, v1}, Lg1/d;->d(Ljava/lang/Object;Ljava/lang/String;)V

    sput-object v0, Lcom/cx/goatlin/NotesProvider;->h:Landroid/net/Uri;

    const-string v0, "data"

    sput-object v0, Lcom/cx/goatlin/NotesProvider;->i:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/cx/goatlin/NotesProvider;->b:I

    const/4 v1, 0x2

    iput v1, p0, Lcom/cx/goatlin/NotesProvider;->c:I
    ...
    iput-object v2, p0, Lcom/cx/goatlin/NotesProvider;->d:Landroid/content/UriMatcher;

    sget-object v3, Lcom/cx/goatlin/NotesProvider;->f:Ljava/lang/String;

    sget-object v4, Lcom/cx/goatlin/NotesProvider;->g:Ljava/lang/String;
...
.method public static final synthetic a()Landroid/net/Uri;
    ...
    sget-object v0, Lcom/cx/goatlin/NotesProvider;->h:Landroid/net/Uri;
...
.method public delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string p3, "Implement this to handle requests to delete one or more rows"
    ...
    invoke-direct {p1, p2}, Lz0/g;-><init>(Ljava/lang/String;)V
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    iget-object v0, p0, Lcom/cx/goatlin/NotesProvider;->d:Landroid/content/UriMatcher;

    invoke-virtual {v0, p1}, Landroid/content/UriMatcher;->match(Landroid/net/Uri;)I

    move-result v0

    iget-object v1, p0, Lcom/cx/goatlin/NotesProvider;->a:Le0/c;
    ...
    iget v3, p0, Lcom/cx/goatlin/NotesProvider;->b:I

    if-ne v0, v3, :cond_1

    sget-object v0, Lcom/cx/goatlin/NotesProvider;->g:Ljava/lang/String;
...
.method public onCreate()Z
    ...
    iput-object v0, p0, Lcom/cx/goatlin/NotesProvider;->a:Le0/c;
    ...
    invoke-virtual {v0, v1}, Le0/e;->e(Landroid/content/Context;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget v2, p0, Lcom/cx/goatlin/NotesProvider;->c:I
    ...
    :cond_0
    iget v2, p0, Lcom/cx/goatlin/NotesProvider;->b:I

    if-ne v0, v2, :cond_2

    :goto_0
    iget-object v0, p0, Lcom/cx/goatlin/NotesProvider;->a:Le0/c;
...
.method public update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string p3, "Implement this to handle requests to update one or more rows."
