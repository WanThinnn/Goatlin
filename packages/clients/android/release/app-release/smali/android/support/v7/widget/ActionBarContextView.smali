...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/h1;->l(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/widget/a;->e:I
...
# virtual methods
.method public bridge synthetic f(IJ)Lr/p;
    .locals 0

    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/a;->f(IJ)Lr/p;
...
.method public g()V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->k()V
...
.method public h(Lz/b;)V
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/v7/widget/ActionBarContextView$a;-><init>(Landroid/support/v7/widget/ActionBarContextView;Lz/b;)V

    invoke-virtual {v0, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lz/b;->e()Landroid/view/Menu;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/a;->d:Landroid/support/v7/widget/d;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/d;->I(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/a;->d:Landroid/support/v7/widget/d;

    iget-object v2, p0, Landroid/support/v7/widget/a;->b:Landroid/content/Context;

    invoke-virtual {p1, v1, v2}, Landroid/support/v7/view/menu/e;->c(Landroid/support/v7/view/menu/j;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/a;->d:Landroid/support/v7/widget/d;

    invoke-virtual {p1, p0}, Landroid/support/v7/widget/d;->o(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/k;

    move-result-object p1

    check-cast p1, Landroid/support/v7/widget/ActionMenuView;

    iput-object p1, p0, Landroid/support/v7/widget/a;->c:Landroid/support/v7/widget/ActionMenuView;

    const/4 v1, 0x0

    invoke-static {p1, v1}, Lr/m;->E(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Landroid/support/v7/widget/a;->c:Landroid/support/v7/widget/ActionMenuView;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/d;->B()Z
...
.method protected onLayout(ZIIII)V
    ...
    :goto_3
    iget-object v2, p0, Landroid/support/v7/widget/a;->c:Landroid/support/v7/widget/ActionMenuView;
...
.method protected onMeasure(II)V
    ...
    :cond_1
    iget-object v6, p0, Landroid/support/v7/widget/a;->c:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-boolean v8, p0, Landroid/support/v7/widget/ActionBarContextView;->r:Z
    ...
    :cond_c
    iget v1, p0, Landroid/support/v7/widget/a;->e:I
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarContextView;->i()V
