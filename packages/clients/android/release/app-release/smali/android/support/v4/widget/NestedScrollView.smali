...
.field private final w:Lr/k;

.field private final x:Lr/i;

.field private y:F

.field private z:Landroid/support/v4/widget/NestedScrollView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/NestedScrollView;->r()V
    ...
    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->w:Lr/k;

    new-instance p1, Lr/i;

    invoke-direct {p1, p0}, Lr/i;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v4/widget/NestedScrollView;->x:Lr/i;
...
.method private A(III)Z
    ...
    :goto_0
    invoke-direct {p0, v2, p2, p3}, Landroid/support/v4/widget/NestedScrollView;->k(ZII)Landroid/view/View;
...
.method private B(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->d(Landroid/graphics/Rect;)I
...
.method private C(Landroid/graphics/Rect;Z)Z
    .locals 2
    ...
    :cond_1
    invoke-virtual {p0, v0, p1}, Landroid/support/v4/widget/NestedScrollView;->D(II)V
...
.method private g(I)V
    ...
    invoke-virtual {p0, v1, p1}, Landroid/support/v4/widget/NestedScrollView;->D(II)V
...
.method private h()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->G(I)V
...
.method private k(ZII)Landroid/view/View;
    .locals 12
...
.method private m(I)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->l(I)V
...
.method private t(Landroid/view/View;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v4/widget/NestedScrollView;->v(Landroid/view/View;II)Z
...
.method private static u(Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->u(Landroid/view/View;Landroid/view/View;)Z
...
.method public final E(II)V
    ...
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/widget/NestedScrollView;->D(II)V
...
.method public F(II)Z
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->x:Lr/i;

    invoke-virtual {v0, p1, p2}, Lr/i;->n(II)Z
...
.method public G(I)V
    ...
    invoke-virtual {v0, p1}, Lr/i;->p(I)V
...
.method public a(I)Z
    ...
    invoke-direct {p0, v1, v2, v3}, Landroid/support/v4/widget/NestedScrollView;->v(Landroid/view/View;II)Z
    ...
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->d(Landroid/graphics/Rect;)I
    ...
    invoke-direct {p0, v0}, Landroid/support/v4/widget/NestedScrollView;->t(Landroid/view/View;)Z
...
.method public computeScroll()V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v4/widget/NestedScrollView;->e(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v9}, Landroid/support/v4/widget/NestedScrollView;->x(IIIIIIIIZ)Z
    ...
    invoke-virtual/range {v0 .. v6}, Landroid/support/v4/widget/NestedScrollView;->f(IIII[II)Z
    ...
    invoke-static/range {p0 .. p0}, Lr/m;->y(Landroid/view/View;)V

    goto :goto_4

    :cond_5
    invoke-virtual {v10, v12}, Landroid/support/v4/widget/NestedScrollView;->o(I)Z

    move-result v0

    if-eqz v0, :cond_6

    invoke-virtual {v10, v12}, Landroid/support/v4/widget/NestedScrollView;->G(I)V
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->j(Landroid/view/KeyEvent;)Z
...
.method public dispatchNestedFling(FFZ)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Lr/i;->a(FFZ)Z
...
.method public dispatchNestedPreFling(FF)Z
    ...
    invoke-virtual {v0, p1, p2}, Lr/i;->b(FF)Z
...
.method public dispatchNestedPreScroll(II[I[I)Z
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, Lr/i;->c(II[I[I)Z
...
.method public dispatchNestedScroll(IIII[I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lr/i;->e(IIII[I)Z
...
.method public e(II[I[II)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lr/i;->d(II[I[II)Z
...
.method public f(IIII[II)Z
    ...
    invoke-virtual/range {v0 .. v6}, Lr/i;->f(IIII[II)Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/NestedScrollView;->w:Lr/k;
...
.method public j(Landroid/view/KeyEvent;)Z
    ...
    :cond_4
    invoke-virtual {p0, v2}, Landroid/support/v4/widget/NestedScrollView;->y(I)Z
...
.method public l(I)V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/widget/NestedScrollView;->F(II)Z
...
.method public o(I)Z
    ...
    invoke-virtual {v0, p1}, Lr/i;->i(I)Z
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/NestedScrollView;->s()V
    ...
    :cond_6
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/NestedScrollView;->G(I)V
    ...
    invoke-direct {p0, v4, v0}, Landroid/support/v4/widget/NestedScrollView;->p(II)Z
    ...
    invoke-direct {p0}, Landroid/support/v4/widget/NestedScrollView;->q()V
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v4/widget/NestedScrollView;->F(II)Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static {p2, p0}, Landroid/support/v4/widget/NestedScrollView;->u(Landroid/view/View;Landroid/view/View;)Z
...
.method public onNestedFling(Landroid/view/View;FFZ)Z
    ...
    invoke-direct {p0, p1}, Landroid/support/v4/widget/NestedScrollView;->m(I)V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-direct {p0, p1, p2, p4}, Landroid/support/v4/widget/NestedScrollView;->v(Landroid/view/View;II)Z
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Lr/k;->d(Landroid/view/View;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/NestedScrollView;->s()V
    ...
    invoke-virtual {v10, v13}, Landroid/support/v4/widget/NestedScrollView;->o(I)Z
    ...
    invoke-direct {v10, v0}, Landroid/support/v4/widget/NestedScrollView;->m(I)V
    ...
    invoke-virtual {v10, v1, v13}, Landroid/support/v4/widget/NestedScrollView;->F(II)Z
...
.method public requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-direct {p0, p2, p3}, Landroid/support/v4/widget/NestedScrollView;->C(Landroid/graphics/Rect;Z)Z
...
.method public setNestedScrollingEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lr/i;->k(Z)V
...
.method public startNestedScroll(I)Z
    ...
    invoke-virtual {v0, p1}, Lr/i;->m(I)Z
...
.method public stopNestedScroll()V
    ...
    invoke-virtual {v0}, Lr/i;->o()V

    return-void
.end method

.method x(IIIIIIIIZ)Z
    .locals 12
    ...
    invoke-virtual {p0, v5}, Landroid/support/v4/widget/NestedScrollView;->o(I)Z
...
.method public y(I)Z
    ...
    invoke-direct {p0, p1, v1, v3}, Landroid/support/v4/widget/NestedScrollView;->A(III)Z
