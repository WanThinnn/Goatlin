...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Landroid/support/v4/app/c;->v:Z
...
.method private static l(Landroid/support/v4/app/c$a;)Z
    .locals 1
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/h;->H()Z
...
.method public a(Ljava/util/ArrayList;Ljava/util/ArrayList;)Z
    ...
    invoke-virtual {p1, p0}, Landroid/support/v4/app/n;->h(Landroid/support/v4/app/c;)V
...
.method b(Landroid/support/v4/app/c$a;)V
    .locals 1
...
.method c(I)V
    ...
    iget v5, v4, Landroid/support/v4/app/h;->p:I

    add-int/2addr v5, p1

    iput v5, v4, Landroid/support/v4/app/h;->p:I

    sget-boolean v4, Landroid/support/v4/app/n;->D:Z
    ...
    iget-object v5, v3, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/h;
    ...
    iget v3, v3, Landroid/support/v4/app/h;->p:I
...
.method public d(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, p3, p2}, Landroid/support/v4/app/c;->e(Ljava/lang/String;Ljava/io/PrintWriter;Z)V
...
.method f()V
    ...
    invoke-virtual {v5, v6, v7}, Landroid/support/v4/app/h;->W0(II)V
    ...
    invoke-virtual {v6, v7}, Landroid/support/v4/app/n;->Z0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->Z0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v5, v6}, Landroid/support/v4/app/h;->V0(I)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->r(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->c1(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->s0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5}, Landroid/support/v4/app/n;->M0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v6, v5, v1}, Landroid/support/v4/app/n;->i(Landroid/support/v4/app/h;Z)V
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/n;->C0(Landroid/support/v4/app/h;)V
    ...
    iget v1, v0, Landroid/support/v4/app/n;->l:I

    invoke-virtual {v0, v1, v3}, Landroid/support/v4/app/n;->D0(IZ)V
...
.method g(Z)V
    ...
    invoke-static {v4}, Landroid/support/v4/app/n;->R0(I)I

    move-result v4

    iget v5, p0, Landroid/support/v4/app/c;->h:I

    invoke-virtual {v3, v4, v5}, Landroid/support/v4/app/h;->W0(II)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->Z0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v4/app/n;->Z0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/h;->V0(I)V

    iget-object v4, p0, Landroid/support/v4/app/c;->a:Landroid/support/v4/app/n;

    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->r(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->s0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->c1(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v4, v3, v5}, Landroid/support/v4/app/n;->i(Landroid/support/v4/app/h;Z)V
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/n;->M0(Landroid/support/v4/app/h;)V
    ...
    invoke-virtual {v2, v3}, Landroid/support/v4/app/n;->C0(Landroid/support/v4/app/h;)V
    ...
    iget v0, p1, Landroid/support/v4/app/n;->l:I

    invoke-virtual {p1, v0, v1}, Landroid/support/v4/app/n;->D0(IZ)V
...
.method h(Ljava/util/ArrayList;Landroid/support/v4/app/h;)Landroid/support/v4/app/h;
    .locals 16
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v8, v11, v3}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/h;)V

    invoke-virtual {v6, v4, v8}, Ljava/util/ArrayList;->add(ILjava/lang/Object;)V

    add-int/lit8 v4, v4, 0x1

    iget-object v3, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/h;

    goto/16 :goto_3

    :cond_1
    iget-object v6, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/h;

    invoke-virtual {v1, v6}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    iget-object v5, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/h;

    if-ne v5, v3, :cond_9

    iget-object v3, v0, Landroid/support/v4/app/c;->b:Ljava/util/ArrayList;

    new-instance v6, Landroid/support/v4/app/c$a;

    invoke-direct {v6, v11, v5}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/h;)V
    ...
    iget v8, v6, Landroid/support/v4/app/h;->w:I
    ...
    check-cast v14, Landroid/support/v4/app/h;

    iget v15, v14, Landroid/support/v4/app/h;->w:I
    ...
    invoke-direct {v15, v11, v14}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/h;)V
    ...
    invoke-direct {v15, v10, v14}, Landroid/support/v4/app/c$a;-><init>(ILandroid/support/v4/app/h;)V
    ...
    :cond_7
    iput v7, v5, Landroid/support/v4/app/c$a;->a:I
    ...
    :cond_8
    iget-object v2, v5, Landroid/support/v4/app/c$a;->b:Landroid/support/v4/app/h;
...
.method j(I)Z
    ...
    iget v3, v3, Landroid/support/v4/app/h;->w:I
...
.method k(Ljava/util/ArrayList;II)Z
    ...
    iget v4, v4, Landroid/support/v4/app/h;->w:I
    ...
    iget v8, v8, Landroid/support/v4/app/h;->w:I
...
.method m()Z
    ...
    invoke-static {v2}, Landroid/support/v4/app/c;->l(Landroid/support/v4/app/c$a;)Z
...
.method o(Landroid/support/v4/app/h$e;)V
    .locals 3
    ...
    invoke-static {v1}, Landroid/support/v4/app/c;->l(Landroid/support/v4/app/c$a;)Z
    ...
    invoke-virtual {v1, p1}, Landroid/support/v4/app/h;->X0(Landroid/support/v4/app/h$e;)V
...
.method p(Ljava/util/ArrayList;Landroid/support/v4/app/h;)Landroid/support/v4/app/h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
