.class Landroid/support/v7/widget/StaggeredGridLayoutManager$f;
...
.method a()V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/StaggeredGridLayoutManager$f;->f(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$c;

    move-result-object v1

    iget-object v3, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager$f;->f:Landroid/support/v7/widget/StaggeredGridLayoutManager;

    iget-object v3, v3, Landroid/support/v7/widget/StaggeredGridLayoutManager;->s:Landroid/support/v7/widget/t0;
    ...
    iget-boolean v0, v1, Landroid/support/v7/widget/StaggeredGridLayoutManager$c;->f:Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager;->B:Landroid/support/v7/widget/StaggeredGridLayoutManager$d;

    invoke-virtual {v1}, Landroid/support/v7/widget/u0$n;->a()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/StaggeredGridLayoutManager$d;->e(I)Landroid/support/v7/widget/StaggeredGridLayoutManager$d$a;

    move-result-object v0

    if-eqz v0, :cond_0

    iget v1, v0, Landroid/support/v7/widget/StaggeredGridLayoutManager$d$a;->b:I

    if-ne v1, v2, :cond_0

    iget v1, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager$f;->c:I

    iget v2, p0, Landroid/support/v7/widget/StaggeredGridLayoutManager$f;->e:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/StaggeredGridLayoutManager$d$a;->a(I)I
...
.method b()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/StaggeredGridLayoutManager;->s:Landroid/support/v7/widget/t0;
...
.method f(Landroid/view/View;)Landroid/support/v7/widget/StaggeredGridLayoutManager$c;
    .locals 0
