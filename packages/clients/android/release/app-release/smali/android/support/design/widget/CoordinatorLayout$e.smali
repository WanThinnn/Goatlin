...
.method public constructor <init>(II)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout$e;->q:Landroid/graphics/Rect;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v2, p0, Landroid/support/design/widget/CoordinatorLayout$e;->q:Landroid/graphics/Rect;

    sget-object v2, Lf/j;->I:[I
    ...
    invoke-static {p1, p2, v0}, Landroid/support/design/widget/CoordinatorLayout;->I(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroid/support/design/widget/CoordinatorLayout$b;
    ...
    invoke-virtual {p1, p0}, Landroid/support/design/widget/CoordinatorLayout$b;->g(Landroid/support/design/widget/CoordinatorLayout$e;)V
...
.method private n(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
    .locals 4
...
.method private s(Landroid/view/View;I)Z
    ...
    invoke-static {v0, p2}, Lr/d;->b(II)I
...
.method private t(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)Z
    .locals 4
...
.method b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    .locals 1
    ...
    invoke-direct {p0, p3, v0}, Landroid/support/design/widget/CoordinatorLayout$e;->s(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/design/widget/CoordinatorLayout$b;->e(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method d(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;
    .locals 2
    ...
    invoke-direct {p0, p2, p1}, Landroid/support/design/widget/CoordinatorLayout$e;->t(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)Z
    ...
    :cond_1
    invoke-direct {p0, p2, p1}, Landroid/support/design/widget/CoordinatorLayout$e;->n(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
...
.method public f()Landroid/support/design/widget/CoordinatorLayout$b;
    .locals 1
...
.method h()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$e;->q:Landroid/graphics/Rect;

    return-object v0
.end method

.method i(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    .locals 2
    ...
    invoke-virtual {v1, p1, p2}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method j(I)Z
    ...
    :cond_0
    iget-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$e;->o:Z

    return p1

    :cond_1
    iget-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$e;->n:Z
...
.method k()V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/CoordinatorLayout$e;->p:Z
...
.method l(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/design/widget/CoordinatorLayout$e;->r(IZ)V
...
.method public o(Landroid/support/design/widget/CoordinatorLayout$b;)V
    .locals 1
    ...
    invoke-virtual {v0}, Landroid/support/design/widget/CoordinatorLayout$b;->j()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/CoordinatorLayout$e;->r:Ljava/lang/Object;
...
.method p(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/CoordinatorLayout$e;->p:Z
...
.method r(IZ)V
    ...
    :cond_0
    iput-boolean p2, p0, Landroid/support/design/widget/CoordinatorLayout$e;->o:Z

    goto :goto_0

    :cond_1
    iput-boolean p2, p0, Landroid/support/design/widget/CoordinatorLayout$e;->n:Z
