...
# instance fields
.field c:Landroid/support/v7/view/menu/g;

.field private d:Ljava/lang/CharSequence;

.field private e:Landroid/graphics/drawable/Drawable;

.field f:Landroid/support/v7/view/menu/e$b;

.field private g:Landroid/support/v7/widget/k0;

.field h:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/a0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private g()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g;

    invoke-virtual {v2}, Landroid/support/v7/view/menu/g;->A()Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/g;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/g;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/g;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g;
    ...
    :goto_3
    invoke-static {p0, v1}, Landroid/support/v7/widget/j1;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_4

    :cond_6
    invoke-static {p0, v2}, Landroid/support/v7/widget/j1;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public b(Landroid/support/v7/view/menu/g;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g;
    ...
    invoke-virtual {p1}, Landroid/support/v7/view/menu/g;->getItemId()I
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/widget/k0;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/widget/k0;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/view/menu/e$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g;

    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/e$b;->a(Landroid/support/v7/view/menu/g;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/g;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/widget/k0;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Landroid/support/v7/view/menu/g;
...
.method public setItemInvoker(Landroid/support/v7/view/menu/e$b;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Landroid/support/v7/view/menu/e$b;
...
.method public setPopupCallback(Landroid/support/v7/view/menu/ActionMenuItemView$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Landroid/support/v7/view/menu/ActionMenuItemView$b;
