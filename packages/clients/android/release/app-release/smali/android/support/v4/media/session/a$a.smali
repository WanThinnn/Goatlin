...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->j(I)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->g(I)V
    ...
    :cond_2
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->n(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    ...
    :cond_5
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->f(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    :cond_6
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->k(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    :cond_7
    invoke-interface {p0, p1, v3}, Landroid/support/v4/media/session/a;->l(Ljava/lang/String;Landroid/os/Bundle;)V
