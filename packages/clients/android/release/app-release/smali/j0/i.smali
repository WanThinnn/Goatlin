...
.method public varargs constructor <init>([Lg0/b;)V
    .locals 4
    ...
    iput-object v0, p0, Lj0/i;->a:Ljava/util/List;
    ...
    iget-object v3, p0, Lj0/i;->a:Ljava/util/List;
...
.method public a(Lg0/b;)Z
    ...
    invoke-virtual {p0, p1}, Lj0/i;->b(Lg0/b;)Z
...
.method public b(Lg0/b;)Z
    ...
    :cond_1
    iget-object v0, p0, Lj0/i;->a:Ljava/util/List;
...
.method d(Ljava/util/List;)V
    ...
    invoke-direct {p1, v0}, Lh0/a;-><init>(Ljava/lang/Iterable;)V
...
.method public dispose()V
    ...
    iput-boolean v0, p0, Lj0/i;->b:Z

    iget-object v0, p0, Lj0/i;->a:Ljava/util/List;

    const/4 v1, 0x0

    iput-object v1, p0, Lj0/i;->a:Ljava/util/List;

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {p0, v0}, Lj0/i;->d(Ljava/util/List;)V
