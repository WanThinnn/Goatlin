...
.field private baseUrl:Ll1/s;

.field private callFactory:Ll1/d$a;
...
.method constructor <init>(Lretrofit2/Retrofit;)V
    ...
    iget-object v2, p1, Lretrofit2/Retrofit;->callFactory:Ll1/d$a;

    iput-object v2, p0, Lretrofit2/Retrofit$Builder;->callFactory:Ll1/d$a;

    iget-object v2, p1, Lretrofit2/Retrofit;->baseUrl:Ll1/s;

    iput-object v2, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Ll1/s;
...
.method public baseUrl(Ljava/lang/String;)Lretrofit2/Retrofit$Builder;
    ...
    invoke-virtual {p0, v0}, Lretrofit2/Retrofit$Builder;->baseUrl(Ll1/s;)Lretrofit2/Retrofit$Builder;
...
.method public baseUrl(Ll1/s;)Lretrofit2/Retrofit$Builder;
    .locals 3
    ...
    invoke-virtual {p1}, Ll1/s;->r()Ljava/util/List;
    ...
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Ll1/s;
...
.method public build()Lretrofit2/Retrofit;
    ...
    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Ll1/s;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->callFactory:Ll1/d$a;
    ...
    iget-object v3, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Ll1/s;

    iget-boolean v7, p0, Lretrofit2/Retrofit$Builder;->validateEagerly:Z

    move-object v1, v0

    invoke-direct/range {v1 .. v7}, Lretrofit2/Retrofit;-><init>(Ll1/d$a;Ll1/s;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
...
.method public callFactory(Ll1/d$a;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Ll1/d$a;
...
.method public client(Ll1/w;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->callFactory(Ll1/d$a;)Lretrofit2/Retrofit$Builder;
