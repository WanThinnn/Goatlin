...
.method private createRawCall()Ll1/d;
    .locals 2
    ...
    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toRequest([Ljava/lang/Object;)Ll1/z;

    move-result-object v0

    iget-object v1, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    iget-object v1, v1, Lretrofit2/ServiceMethod;->callFactory:Ll1/d$a;

    invoke-interface {v1, v0}, Ll1/d$a;->a(Ll1/z;)Ll1/d;
...
.method public cancel()V
    ...
    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Ll1/d;
...
.method public enqueue(Lretrofit2/Callback;)V
    ...
    :try_start_1
    invoke-direct {p0}, Lretrofit2/OkHttpCall;->createRawCall()Ll1/d;

    move-result-object v2

    iput-object v2, p0, Lretrofit2/OkHttpCall;->rawCall:Ll1/d;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-interface {v0, v1}, Ll1/d;->u(Ll1/e;)V
...
.method public execute()Lretrofit2/Response;
    ...
    iput-object v0, p0, Lretrofit2/OkHttpCall;->rawCall:Ll1/d;
    :try_end_1
    ...
    :cond_3
    invoke-interface {v0}, Ll1/d;->execute()Ll1/b0;

    move-result-object v0

    invoke-virtual {p0, v0}, Lretrofit2/OkHttpCall;->parseResponse(Ll1/b0;)Lretrofit2/Response;
...
.method public isCanceled()Z
    ...
    invoke-interface {v0}, Ll1/d;->isCanceled()Z
...
.method parseResponse(Ll1/b0;)Lretrofit2/Response;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, v2, v3, v4}, Lretrofit2/OkHttpCall$NoContentResponseBody;-><init>(Ll1/u;J)V

    invoke-virtual {p1, v1}, Ll1/b0$a;->b(Ll1/c0;)Ll1/b0$a;
    ...
    invoke-direct {v1, v0}, Lretrofit2/OkHttpCall$ExceptionCatchingRequestBody;-><init>(Ll1/c0;)V

    :try_start_0
    iget-object v0, p0, Lretrofit2/OkHttpCall;->serviceMethod:Lretrofit2/ServiceMethod;

    invoke-virtual {v0, v1}, Lretrofit2/ServiceMethod;->toResponse(Ll1/c0;)Ljava/lang/Object;

    move-result-object v0

    invoke-static {v0, p1}, Lretrofit2/Response;->success(Ljava/lang/Object;Ll1/b0;)Lretrofit2/Response;
    ...
    :goto_1
    :try_start_1
    invoke-static {v0}, Lretrofit2/Utils;->buffer(Ll1/c0;)Ll1/c0;

    move-result-object v1

    invoke-static {v1, p1}, Lretrofit2/Response;->error(Ll1/c0;Ll1/b0;)Lretrofit2/Response;
...
.method public declared-synchronized request()Ll1/z;
    .locals 3
    ...
    invoke-interface {v0}, Ll1/d;->request()Ll1/z;
